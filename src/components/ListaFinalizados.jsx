...
const ListaFinalizados = () => {
  ...
  return (
    <div className="w-full overflow-x-auto">
      <table className="min-w-full rounded-lg shadow-md text-sm md:text-base">
        {/* Cabeçalho da Tabela */}
        <thead className="bg-slate-800 text-slate-50 font-semibold text-sm md:text-lg rounded-t-lg">
          <tr>
