...
const Sidebar = () => {
    ...
    return (
        <aside className={`z-50 fixed transition-all duration-200 border-b border-slate-300 border-r h-full flex bg-slate-50 shadow-sm flex-col ${expanded? "w-2/3 md:w-1/3 lg:w-1/5" : "w-16"}`}>
